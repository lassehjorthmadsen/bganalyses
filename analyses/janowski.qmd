...
Of course, the interesting bit is the *actual* take points; the "Dead" and "Perfectly live" take point are just lower and upper bounds between which the "real" take point must be found. Janowski just takes a weighted average of the two, to arrive at a guesstimate for the actual or real take point. The weight used is called the cube-life index, more on that in a moment. 
