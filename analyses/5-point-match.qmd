...
11 doesn't necessarily save a roll, so White is a bit worse off compared to a pure 4-roll position. Enough to turn a money take into a pass at the score.
...
When Black has a match winning gammon threat, this small money take becomes a gigantic pass at 2-away, 4-away
...
- Naturally, the trailer can take (and redouble) with anything better than the 24.9% he would have had after passing at 3-away, 1-away, Crawford.
...
The two-point match is funny: It's a well-known fact that an optimal strategy is to double at first opportunity, at which point the opponent will always have a clear take, with the take point beeing `r round(met[2,1] * 100, 0)`%.

However, in practice, if you delay doubling until you have at least one market losing sequences, you might gain a bit from either:
...
In practical play, it would be better to roll, since it can't hurt and it opens the possibility of harvesting possible mistakes the opponent might make.
