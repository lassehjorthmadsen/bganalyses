...
- The reason is of course, the the cube is now officially dead after redouble/take, *and* the gammon value drops all the way down to zero for the leader, but quite as low for the trailer:
...
- If White do *not* have an automatic recube available (as in a last-roll situation), he should be careful about taking a redouble at this score.

- Even if the auto-redouble is available, it's considerable harder to find a take than for money.
