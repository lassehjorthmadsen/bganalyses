...
But the big part of the mistake was about failing to account for the match score. It's easy to see how the ability to recube to 4 is a powerful thing for Black when trailing 7-away, 3-away. After a redouble/take, Black can win 4 points, possibly winning a gammon and the match, White can win only 3 points and can't benefit from gammons.

Let's line Black's take points up in a table and compare to money game:
...
The marginal money game take, for example, would still be a sizable no-double, even at the score:
