...
This one, half backgame, half holding game, is a little unusual and can be hard to evaluate. Black is, of course miles behind in the race and need to hit a shot to win. On the positive side, Black has a great defensive structure to generate hits. Not right away, White has no shot-leaving rolls, but there likely will be later. Since this is not a deep backgame, the gammon danger isn't too great. 
...
The market loss that White is hoping for, is something like 62. Then, if Black doesn't roll a very low number, the market will be lost. 

Let's first confirm that this is not due to the match score: For money the no double is actually a little clearerr:
