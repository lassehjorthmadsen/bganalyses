...
The key is, that after the top-play, 9 rolls make a full 5-prime, after the second best, only 4 rolls does that. Some rolls, 31 and 43, makes the 5-point but breaks the 8, which is not as strong. So the extra builders on the 11- and 8-points have real value. 

Note that White should break the 13-point with a lot of rolls: 54, 43, 62, 42, 32, 51, and the 52 in this position.

51 deserves special mention, the funny looking 13/7 is probably slightly better than the aggressive slot: 11/5.
...
Summing up, making the 5-point and a 5-point-prime is likely to win the game, so White can easily afford breaking the midpoint and leaving a few fly-shots to increase the probability of achieving that goal.

Builders win -- if they try to build something important, and if they are not very likely to get hit.